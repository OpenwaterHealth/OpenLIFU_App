...
* Setting up your git account:
    ...
    * If not already done, email `FirstName LastName <firstname.lastname@OpenwaterHealth.com>` to be granted access to
    the [OpenwaterHealth/OpenLIFU-app](https://github.com/OpenwaterHealth/OpenLIFU-app) repository.
